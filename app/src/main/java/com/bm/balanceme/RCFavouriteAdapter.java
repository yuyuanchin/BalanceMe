...
public class RCFavouriteAdapter extends RecyclerView.Adapter<RCFavouriteAdapter.RCGymViewHolder> {

    Context context;

    public RCFavouriteAdapter(Context context, ArrayList<RCGymModel> modelArrayList) {
    ...
    public RCGymViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.rc_favourite_item, parent, false);
    ...
    public class RCGymViewHolder extends RecyclerView.ViewHolder {
        ImageView image;
        TextView title;
        TextView rating;
        TextView address;
